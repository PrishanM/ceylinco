...
public class JsonRequestManager {
	...
	* */
	...
	public void resetPassword(String url, final String nic, final resetPasswordRequest callback) {
	...
	public interface getPerilsRequest {
		void onSuccess(String s);

		void onError(String status);
	}

	public void getPerils(String url, final String category, final String use,final getPerilsRequest callback) {
	...
	public void uploadImage(String url, final String image,final String jobId,final String fileName, final uploadImageRequest callback) {
